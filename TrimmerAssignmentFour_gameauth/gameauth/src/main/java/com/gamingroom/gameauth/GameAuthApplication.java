...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		/*
		 * C. Trimmer: This is registers our custom classes into 
		 * dropwizard security framework
		 */
		...
		/*
		 * C. Trimmer: Creating the JerseyClientBuilder instance and
		 * giving it an environment reference to the client
		 */
